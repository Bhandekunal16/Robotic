...
class  Binary {  convertToBinary(input) {    
    try  {      
        if  (input == undefined)         return   new Response().badRequest("input not be undefined");
      
        if  (typeof input !== "string")        throw new Response().badRequest("Input must be a string");
  ...
  padLeft(str, length) {     return   "0".repeat(length - str.length) + str;
}}
